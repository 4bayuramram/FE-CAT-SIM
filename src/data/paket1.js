const paket1 = {
  ...
  questions: [
    ...
    //integritas
    {
      ...
      topic: "Integritas",
      nomor: 13,
      soal: "Udin adalah seorang pejabat di instansi pemerintah yang sedang menangani proyek pengadaan barang. Dalam prosesnya, ia berkomitmen menjaga integritas agar tidak terjadi penyimpangan. Tindakan berikut yang sesuai dengan nilai integritas yang dapat ditunjukkan Udin adalah …",
      pilihan: {
        a: "Menolak segala bentuk pemberian hadiah dari vendor yang berpotensi memengaruhi keputusan",
        b: "Memilih vendor berdasarkan prosedur dan aturan yang berlaku tanpa intervensi pihak luar",
        c: "Mendokumentasikan seluruh proses pengadaan secara transparan dan dapat dipertanggungjawabkan",
        d: "Melaporkan jika terdapat upaya suap atau gratifikasi kepada pihak berwenang",
        e: "Menjaga jarak profesional dengan pihak vendor agar tidak terjadi konflik kepentingan",
      },
      jawabanBenar: "a",
      poin: 5,
      pembahasan: "mohon maaf, pembahasan pada paket ini tidak tersedia",
    ...
    //no.14
    {
      ...
      topic: "Integritas",
      nomor: 14,
      soal: "Dalam penyelenggaraan tugas di bidang hukum, konflik kepentingan dapat terjadi ketika terdapat hubungan pribadi, emosional, atau kepentingan tertentu yang berpotensi memengaruhi objektivitas dan independensi dalam pengambilan keputusan atau pelaksanaan tugas. Kondisi ini menuntut adanya langkah-langkah yang dapat menjaga integritas proses hukum. Tindakan yang sesuai dengan prinsip integritas dalam menghadapi konflik kepentingan adalah …",
      pilihan: {
        a: "Menolak penggunaan pengaruh pribadi dalam memengaruhi proses hukum",
        b: "Mengalihkan kewenangan atau penanganan perkara kepada pihak yang independen",
        c: "Memastikan keputusan tetap berdasarkan aturan hukum dan bukti yang objektif",
        d: "Menghindari keterlibatan dalam proses yang berpotensi menimbulkan keberpihakan",
        e: "Menjaga transparansi dengan melaporkan adanya potensi konflik kepentingan",
      },
      jawabanBenar: "a",
      poin: 5,
      pembahasan: "mohon maaf, pembahasan pada paket ini tidak tersedia",
    ...
    //no.15
    {
      ...
      topic: "Integritas",
      nomor: 15,
      soal: "Di sebuah desa, pemerintah desa berencana membangun fasilitas umum yang bersinggungan dengan sebagian lahan warga. Beberapa pihak mencoba memengaruhi panitia pembangunan agar proyek berjalan sesuai kepentingan mereka, meskipun tidak sesuai prosedur yang berlaku. Situasi ini berpotensi memengaruhi kesejahteraan warga dan kredibilitas lembaga desa. Sebagai panitia pembangunan yang ingin tetap berintegritas, tindakan yang dapat dilakukan adalah …",
      pilihan: {
        a: "Menyampaikan secara terbuka kepada pihak terkait bahwa setiap keputusan harus mengikuti aturan yang berlaku, agar transparansi tetap terjaga",
        b: "Menolak segala bentuk upaya yang mengarahkan proses keluar dari prosedur yang telah ditetapkan, untuk menjaga prinsip keadilan",
        c: "Mengomunikasikan kondisi yang terjadi kepada pihak yang berwenang, agar keputusan tetap objektif dan dapat dipertanggungjawabkan",
        d: "Memastikan setiap keputusan dan langkah-langkah yang diambil sesuai dengan ketentuan hukum dan aturan desa, sehingga proses legal dan sah secara prosedural",
        e: "Memberikan penjelasan kepada masyarakat mengenai dasar aturan dan konsekuensi dari setiap pelanggaran prosedur, agar warga paham dan ikut menjaga integritas",
      },
      jawabanBenar: "a",
      poin: 5,
      pembahasan: "mohon maaf, pembahasan pada paket ini tidak tersedia",
    ...
    //no.16
    {
      ...
      topic: "Integritas",
      nomor: 16,
      soal: "Seorang kepala dinas memimpin proyek pembangunan sistem transportasi yang dibiayai anggaran publik melalui proses tender terbuka. Salah satu peserta tender memiliki hubungan tidak langsung dengan pejabat internal, namun menawarkan harga lebih rendah dan waktu pengerjaan lebih cepat. Kepala dinas berada dalam tekanan untuk segera mengambil keputusan agar proyek tidak terlambat, namun tetap harus menjaga integritas dalam proses pengadaan. Tindakan yang paling tepat dilakukan adalah …",
      pilihan: {
        a: "Memilih penawaran tercepat dan termurah agar proyek segera dirasakan manfaatnya oleh masyarakat.",
        b: "Menunda keputusan sampai seluruh proses verifikasi dan prosedur tender dipastikan sesuai aturan yang berlaku.",
        c: "Mengutamakan percepatan keputusan karena keterlambatan akan berdampak pada kinerja dinas.",
        d: "Menginformasikan proses tender kepada publik untuk meningkatkan kepercayaan dan transparansi.",
        e: "Mempertimbangkan kedekatan hubungan kerja sebelumnya untuk mempercepat pengambilan keputusan.",
      },
      jawabanBenar: "a",
      poin: 5,
      pembahasan: "mohon maaf, pembahasan pada paket ini tidak tersedia",
    ...
    //no.17
    {
      ...
      topic: "Integritas",
      nomor: 17,
      soal: "Saat mengikuti pelatihan dasar sebagai calon aparatur sipil negara, Udin mendapatkan tugas individu yang harus diselesaikan dalam waktu tiga hari. Menjelang batas waktu pengumpulan, salah seorang temannya menawarkan hasil pekerjaan yang sudah jadi agar dapat langsung disalin dan dikumpulkan. Meskipun sedang menghadapi kesibukan lain, Udin memilih mengerjakan tugasnya sendiri hingga selesai. Sikap Udin tersebut menunjukkan upaya menjaga integritas karena …",
      pilihan: {
        a: "Menggunakan hasil pekerjaan orang lain dapat mengurangi sikap mandiri dalam menyelesaikan tugas",
        b: "Menyalin pekerjaan teman menunjukkan kepedulian terhadap sesama peserta pelatihan",
        c: "Menggunakan hasil pekerjaan teman merupakan bentuk kerja sama yang baik dalam pelatihan",
        d: "Menyalin pekerjaan teman dapat meningkatkan efisiensi penyelesaian tugas",
        e: "Menggunakan hasil pekerjaan teman menunjukkan kemampuan beradaptasi terhadap keadaan yang sulit",
      },
      jawabanBenar: "a",
      poin: 5,
      pembahasan: "mohon maaf, pembahasan pada paket ini tidak tersedia",
    ...
    //no.18
    {
      ...
      topic: "Integritas",
      nomor: 18,
      soal: "Dalam suatu kegiatan sosial yang diselenggarakan oleh kantor, Ujang melihat seorang pegawai baru mengalami kesulitan memahami prosedur pelaksanaan kegiatan. Meskipun hal tersebut bukan termasuk bagian dari tugasnya, Ujang meluangkan waktu untuk memberikan penjelasan agar kegiatan dapat berjalan dengan lancar. Sikap Ujang menunjukkan integritas karena …",
      pilihan: {
        a: "Ujang ingin menunjukkan kemampuannya kepada pegawai baru",
        b: "Ujang berharap memperoleh bantuan serupa di masa mendatang",
        c: "Ujang menunjukkan sikap peduli terhadap kelancaran pelaksanaan tugas bersama",
        d: "Ujang berusaha memperoleh penilaian positif dari pimpinan",
        e: "Ujang ingin memperluas jaringan pertemanan di lingkungan kerja",
      },
      jawabanBenar: "c",
      poin: 5,
      pembahasan: "mohon maaf, pembahasan pada paket ini tidak tersedia",
    ...
    //bahasa indonesia
    {
      ...
      nomor: 19,
      textref: "( Teks untuk nomor 19 dan 20 )",
      soal: "Gerhana Bulan Total terjadi ketika Matahari, Bumi, dan Bulan berada dalam satu garis lurus, sehingga Bulan masuk sepenuhnya ke dalam bayangan inti Bumi. Pada kondisi langit tertentu, Bulan tampak berwarna kemerahan karena penyebaran cahaya Matahari oleh atmosfer Bumi, di mana cahaya dengan panjang gelombang pendek tersebar lebih luas daripada cahaya panjang gelombang. Fenomena ini dapat diamati dari berbagai wilayah, meskipun keterlihatannya berbeda-beda tergantung posisi pengamat dan kondisi atmosfer. Oleh karena itu, pengamatan gerhana sebaiknya dilakukan di lokasi dengan langit cerah dan minim gangguan cahaya buatan agar dapat melihat seluruh fase gerhana dengan jelas.",
      ditanya: "Gagasan pokok dari teks tersebut adalah ....",
      pilihan: {
        a: "Warna kemerahan Bulan saat gerhana Bulan Total akibat penyebaran cahaya Matahari",
        b: "Perbedaan posisi Bumi dan Bulan yang memengaruhi durasi gerhana",
        c: "Fenomena Gerhana Bulan Total dan faktor-faktor yang memengaruhi keterlihatannya di berbagai wilayah",
        d: "Proses pembentukan bayangan inti Bumi secara ilmiah",
        e: "Langkah-langkah teknis pengamatan gerhana agar dapat terlihat dengan jelas",
      },
      jawabanBenar: "c",
      poin: 5,
      pembahasan: "mohon maaf, pembahasan pada paket ini tidak tersedia",
    ...
    //no.20
    {
      ...
      soal: "Gerhana Bulan Total terjadi ketika Matahari, Bumi, dan Bulan berada dalam satu garis lurus, sehingga Bulan masuk sepenuhnya ke dalam bayangan inti Bumi. Pada kondisi langit tertentu, Bulan tampak berwarna kemerahan karena penyebaran cahaya Matahari oleh atmosfer Bumi, di mana cahaya dengan panjang gelombang pendek tersebar lebih luas daripada cahaya panjang gelombang. Fenomena ini dapat diamati dari berbagai wilayah, meskipun keterlihatannya berbeda-beda tergantung posisi pengamat dan kondisi atmosfer. Oleh karena itu, pengamatan gerhana sebaiknya dilakukan di lokasi dengan langit cerah dan minim gangguan cahaya buatan agar dapat melihat seluruh fase gerhana dengan jelas.",
      ditanya:
        "Kata 'meskipun' pada bacaan berfungsi untuk menyatakan hubungan ....",
      pilihan: {
        a: "Pertentangan antara dua kondisi yang berbeda, yaitu keterlihatan gerhana dan kondisi atmosfer atau pengamat",
        b: "Hubungan sebab-akibat antara posisi Bulan dan warna kemerahan yang terlihat",
        c: "Penegasan terhadap fakta bahwa gerhana selalu terjadi setiap bulan purnama",
        d: "Penambahan informasi mengenai lokasi pengamatan yang optimal",
        e: "Kesimpulan dari seluruh proses terjadinya gerhana",
      },
      jawabanBenar: "a",
      poin: 5,
      pembahasan: "mohon maaf, pembahasan pada paket ini tidak tersedia",
    ...
    //no.21
    {
      ...
      nomor: 21,
      textref:
        "Meskipun berbagai program telah dilaksanakan oleh pemerintah, tetapi angka kemiskinan di beberapa daerah masih relatif tinggi.",
      soal: "Kalimat diatas merupakan kalimat yang tidak efektif, alasannya adalah ....",
      pilihan: {
        a: "Penggunaan kata tidak sesuai konteks",
        b: "Kalimat tidak memiliki objek",
        c: "Penggunaan dua konjungsi yang menyatakan hubungan sama",
        d: "Terdapat pengulangan subjek",
        e: "Penggunaan predikat tidak tepat",
      },
      jawabanBenar: "c",
      poin: 5,
      pembahasan: "mohon maaf, pembahasan pada paket ini tidak tersedia",
    ...
    //no.22
    {
      ...
      topic: "Bahasa Indonesia",
      nomor: 22,
      soal: "Pemanfaatan energi terbarukan semakin penting dalam upaya menjaga ketahanan energi nasional dan mengurangi dampak negatif terhadap lingkungan. Pemerintah mendorong penggunaan energi surya, angin, dan biomassa agar dapat menggantikan sebagian penggunaan bahan bakar fosil. Kendati demikian, penerapannya masih menghadapi kendala, antara lain tingginya biaya investasi, keterbatasan teknologi di beberapa daerah, serta rendahnya literasi masyarakat mengenai cara memanfaatkan energi terbarukan secara optimal. Pernyataan berikut yang dapat memperlemah bacaan di atas adalah ....",
      pilihan: {
        a: "Energi surya dan angin menjadi sumber energi utama di beberapa negara maju dan terbukti mampu mengurangi ketergantungan bahan bakar fosil",
        b: "Beberapa daerah di Indonesia telah mampu memanfaatkan energi terbarukan secara efektif tanpa biaya tinggi karena dukungan teknologi lokal",
        c: "Pemerintah telah menyediakan panduan penggunaan energi terbarukan untuk meningkatkan literasi masyarakat",
        d: "Kendala biaya dan teknologi menjadi faktor penting yang memperlambat implementasi energi terbarukan",
        e: "Energi terbarukan memiliki manfaat jangka panjang bagi lingkungan dan ketahanan energi nasional",
      },
      jawabanBenar: "b",
      poin: 5,
      pembahasan: "mohon maaf, pembahasan pada paket ini tidak tersedia",
    ...
    //no.23
    {
      ...
      nomor: 23,
      type: "bacaan2",
      textref: "(Teks untuk nomor 23 dan 24)",
      p1: "Program penyediaan makanan bergizi gratis bagi peserta didik di beberapa wilayah Indonesia dilaporkan memiliki potensi dalam meningkatkan konsentrasi belajar siswa. Program tersebut dirancang untuk memastikan anak-anak memperoleh asupan gizi yang memadai sehingga dapat mendukung fungsi kognitif dan kemampuan belajar di sekolah. Hasil kajian awal di sejumlah daerah menunjukkan adanya peningkatan fokus belajar pada siswa yang mendapatkan asupan gizi lebih baik dibandingkan sebelumnya.",
      p2: "Meskipun demikian, penerapan program ini masih menghadapi berbagai tantangan, seperti perbedaan kondisi infrastruktur antarwilayah, keterbatasan distribusi pangan, serta tingkat pemahaman masyarakat mengenai pentingnya gizi seimbang. Oleh karena itu, implementasi program ini dipandang sebagai salah satu upaya strategis dalam meningkatkan kualitas pendidikan, namun tetap memerlukan evaluasi dan penyesuaian agar dapat berjalan secara efektif di berbagai daerah.",
      ditanya:
        "Pernyataan yang paling tepat menggambarkan gagasan pokok bacaan adalah ....",
      pilihan: {
        a: "Kajian awal menunjukkan peningkatan fokus belajar siswa tanpa kaitan dengan program gizi",
        b: "Distribusi pangan menjadi faktor utama keberhasilan program di seluruh wilayah",
        c: "Program makanan bergizi tidak memiliki dampak terhadap proses pembelajaran siswa",
        d: "Upaya penyediaan makanan bergizi bagi siswa berpotensi meningkatkan kualitas pendidikan meskipun masih menghadapi berbagai tantangan",
        e: "Pemerintah tidak perlu melanjutkan program karena banyak hambatan teknis di lapangan",
      },
      jawabanBenar: "d",
      poin: 5,
      pembahasan: "mohon maaf, pembahasan pada paket ini tidak tersedia",
    ...
    //no.24
    {
      ...
      p2: "Meskipun demikian, penerapan program ini masih menghadapi berbagai tantangan, seperti perbedaan kondisi infrastruktur antarwilayah, keterbatasan distribusi pangan, serta tingkat pemahaman masyarakat mengenai pentingnya gizi seimbang. Oleh karena itu, implementasi program ini dipandang sebagai salah satu upaya strategis dalam meningkatkan kualitas pendidikan, namun tetap memerlukan evaluasi dan penyesuaian agar dapat berjalan secara efektif di berbagai daerah.",
      ditanya:
        "Pernyataan yang paling tepat sebagai kesimpulan dari bacaan adalah ....",
      pilihan: {
        a: "Program makanan bergizi pasti menghasilkan peningkatan prestasi akademik di semua wilayah",
        b: "Kajian awal tidak dapat dijadikan dasar kebijakan pendidikan nasional",
        c: "Program ini tidak memiliki hubungan dengan peningkatan konsentrasi belajar siswa",
        d: "Program makanan bergizi berpotensi meningkatkan kualitas belajar siswa, tetapi efektivitasnya masih perlu penyesuaian dan evaluasi",
        e: "Tantangan distribusi membuat program ini tidak dapat dilaksanakan secara nasional",
      },
      jawabanBenar: "d",
      poin: 5,
      pembahasan: "mohon maaf, pembahasan pada paket ini tidak tersedia",
    ...
    //no.25
    {
      ...
      topic: "Bela Negara",
      nomor: 25,
      soal: "Pemerintah merencanakan pembangunan fasilitas pertahanan di wilayah pesisir untuk memperkuat kedaulatan negara, namun sebagian warga menolak karena dampak sosial dan lingkungan. Sebagai pelajar, sikap paling mencerminkan nilai bela negara adalah …",
      pilihan: {
        a: "Mendukung penolakan warga karena menjaga kepentingan lingkungan lokal adalah bentuk kepedulian terhadap masyarakat",
        b: "Menyuarakan kekhawatiran di media sosial agar isu diketahui publik secara luas dan transparan",
        c: "Mendukung kebijakan pemerintah demi kepentingan pertahanan dan kedaulatan negara",
        d: "Bersikap netral agar tidak memperkeruh situasi dan menjaga ketenangan lingkungan sekitar",
        e: "Mencari informasi dari berbagai pihak dan ikut mendorong dialog yang seimbang antara kepentingan lokal dan nasional",
      },
      jawabanBenar: "e",
      poin: 5,
      pembahasan: "mohon maaf, pembahasan pada paket ini tidak tersedia",
    ...
    //no.26
    {
      ...
      topic: "Bela Negara",
      nomor: 26,
      soal: "Seorang dosen menyadari beberapa mahasiswa terpengaruh paham yang melemahkan nilai kebangsaan. Ia ingin tetap menjalankan tugas akademik sekaligus membela negara. Bentuk bela negara yang dapat dilakukan dosen tersebut adalah …",
      pilihan: {
        a: "Memberikan pembelajaran yang menekankan nilai kebangsaan melalui materi kuliah",
        b: "Membimbing mahasiswa melalui diskusi kritis agar memahami konsekuensi ideologi yang merugikan persatuan",
        c: "Menjaga netralitas sambil tetap mengamati perkembangan sikap mahasiswa",
        d: "Mengedukasi mahasiswa melalui kegiatan akademik dan proyek sosial yang memperkuat persatuan",
        e: "Memanfaatkan teknologi dan media kampus untuk menyebarkan informasi positif tentang kebangsaan",
      },
      jawabanBenar: "d",
      poin: 5,
      pembahasan: "mohon maaf, pembahasan pada paket ini tidak tersedia",
    ...
    //no.27
    {
      ...
      topic: "Bela Negara",
      nomor: 27,
      soal: "Bela negara merupakan tekad, sikap, dan tindakan warga negara yang dilandasi kecintaan terhadap NKRI, Pancasila, dan UUD 1945, yang bertujuan menjaga kedaulatan, keutuhan wilayah, dan keselamatan bangsa. Nilai-nilai dasarnya dapat diwujudkan dalam kehidupan sehari-hari melalui sikap cinta tanah air, kesadaran berbangsa dan bernegara, setia pada Pancasila, rela berkorban, serta kemampuan awal bela negara. Berdasarkan indikator tersebut, yang tidak termasuk perwujudan nilai dasar bela negara adalah …",
      pilihan: {
        a: "Menggunakan produk dalam negeri dan menjaga kelestarian budaya sebagai bentuk cinta tanah air",
        b: "Menghargai perbedaan pendapat serta mematuhi aturan yang berlaku di lingkungan masyarakat",
        c: "Mengutamakan musyawarah dan toleransi dalam menyelesaikan permasalahan bersama",
        d: "Mendahulukan kepentingan pribadi dalam setiap keputusan agar kesejahteraan individu tetap terjaga",
        e: "Menjaga kesehatan fisik dan mental serta bersikap disiplin dalam menjalankan tugas sehari-hari",
      },
      jawabanBenar: "d",
      poin: 5,
      pembahasan: "mohon maaf, pembahasan pada paket ini tidak tersedia",
    ...
    //  no 66
    {
      ...
      nomor: 66,
      soal: `Anda ditugaskan sebagai anggota panitia dalam sebuah kegiatan pelayanan masyarakat yang melibatkan berbagai organisasi kemasyarakatan, komunitas pemuda, dan kelompok keagamaan. Menjelang pelaksanaan kegiatan, salah satu kelompok peserta mengusulkan agar sesi pembukaan hanya menampilkan simbol dan identitas kelompok mereka karena merasa memiliki kontribusi terbesar dalam penyelenggaraan acara. Di sisi lain, beberapa kelompok lain mulai menyampaikan keberatan karena khawatir hal tersebut menimbulkan kesan eksklusif dan mengurangi semangat kebersamaan yang menjadi tujuan kegiatan. Sebagai panitia, sikap yang paling tepat adalah...`,
      pilihan: {
        a: "Menghormati usulan tersebut karena setiap kelompok berhak menampilkan identitasnya selama tidak mengganggu jalannya kegiatan.",
        b: "Menyetujui usulan tersebut demi menghindari perdebatan yang berpotensi menghambat persiapan acara yang sudah mendekati hari pelaksanaan.",
        c: "Mengajak seluruh perwakilan kelompok berdiskusi untuk mencari format pembukaan yang tetap menghargai kontribusi semua pihak serta mencerminkan semangat kebersamaan.",
        d: "Menyerahkan keputusan sepenuhnya kepada pimpinan kegiatan agar tidak terjadi konflik antarkelompok yang semakin meluas.",
        e: "Membiarkan masing-masing kelompok menampilkan identitasnya sendiri-sendiri tanpa melakukan pengaturan khusus agar semua pihak merasa diperlakukan sama.",
      },
      scoringMap: {
        a: 3,
        b: 2,
    ...
    //no.67
    {
      ...
      topic: "Anti Radikalisme",
      nomor: 67,
      soal: `Anda tergabung dalam tim penyelenggara kegiatan sosialisasi nasional yang melibatkan peserta dari berbagai daerah dan latar belakang agama. Beberapa hari sebelum pelaksanaan, diketahui bahwa salah satu sesi penting dijadwalkan bertepatan dengan waktu ibadah sebagian peserta. Jika jadwal tersebut dipertahankan, target kegiatan tetap tercapai, tetapi beberapa peserta akan kesulitan mengikuti sesi secara optimal. Sementara itu, perubahan jadwal berpotensi memengaruhi rangkaian acara yang telah disusun. Sebagai anggota tim penyelenggara, tindakan yang paling tepat adalah...`,
      pilihan: {
        a: "Mempertahankan jadwal yang telah ditetapkan karena seluruh peserta telah menerima informasi kegiatan jauh hari sebelumnya.",
        b: "Mengusulkan penyesuaian teknis pelaksanaan sesi agar peserta yang menjalankan ibadah tetap dapat berpartisipasi tanpa mengurangi kualitas kegiatan secara keseluruhan.",
        c: "Menyerahkan keputusan kepada ketua panitia karena perubahan jadwal merupakan kewenangan pimpinan kegiatan.",
        d: "Meminta peserta yang memiliki kebutuhan ibadah untuk menyesuaikan diri dengan jadwal kegiatan demi menjaga kelancaran acara.",
        e: "Mengusulkan penghapusan sesi tersebut dan menggantinya dengan materi yang dapat dipelajari secara mandiri oleh peserta.",
      },
      scoringMap: {
        a: 3,
        b: 5, // paling ideal (fleksibel + inklusif + tetap menjaga kualitas kegiatan)
        c: 2,
        d: 1,
        e: 4,
      },
    ...
    // no.68
    {
      ...
      topic: "Anti Radikalisme",
      nomor: 68,
      soal: `Anda merupakan koordinator kegiatan di sebuah balai pelatihan milik pemerintah yang pesertanya berasal dari berbagai daerah dan latar belakang. Menjelang pelaksanaan acara penutupan, Anda menerima informasi bahwa beberapa peserta mulai mengelompok secara eksklusif dan menyebarkan ajakan melalui grup percakapan untuk tidak berinteraksi dengan peserta tertentu karena dianggap memiliki keyakinan yang berbeda. Meskipun belum terjadi konflik terbuka, beberapa peserta mulai merasa tidak nyaman dan suasana kebersamaan yang sebelumnya terjalin mulai berkurang. Sebagai koordinator kegiatan, tindakan yang paling tepat adalah...`,
      pilihan: {
        a: "Mengingatkan seluruh peserta untuk tetap fokus pada tujuan pelatihan dan menghindari pembahasan yang berpotensi menimbulkan perpecahan selama kegiatan berlangsung.",
        b: "Mengumpulkan informasi dari berbagai pihak terkait situasi yang terjadi, kemudian memfasilitasi dialog yang menekankan penghormatan terhadap keberagaman serta memastikan seluruh peserta memperoleh perlakuan yang setara.",
        c: "Memantau perkembangan situasi terlebih dahulu karena belum terdapat pelanggaran yang secara langsung mengganggu jalannya pelatihan.",
        d: "Menghubungi peserta yang diduga memulai ajakan tersebut dan meminta mereka menghentikan aktivitasnya agar suasana pelatihan kembali kondusif.",
        e: "Mengadakan kegiatan kebersamaan yang melibatkan seluruh peserta dengan harapan hubungan antar peserta dapat membaik secara alami tanpa perlu membahas akar permasalahannya secara langsung.",
      },
      scoringMap: {
        a: 3,
        b: 5, // paling ideal (klarifikasi + dialog + inklusif + pencegahan konflik)
        c: 2,
        d: 4,
        e: 1,
      },
    ...
    // no.69
    {
      ...
      topic: "Anti Radikalisme",
      nomor: 69,
      soal: `Anda bekerja sebagai staf pada bidang kemahasiswaan di sebuah perguruan tinggi negeri. Dalam beberapa bulan terakhir, muncul komunitas mahasiswa yang aktif mengadakan diskusi tertutup dan sering menyebarkan narasi bahwa kelompok yang memiliki pandangan berbeda tidak layak dilibatkan dalam berbagai kegiatan kampus. Meskipun belum ada pelanggaran aturan yang terjadi, sejumlah organisasi mahasiswa mulai mengeluhkan berkurangnya interaksi dan meningkatnya sikap eksklusif antar kelompok. Pimpinan kampus meminta masukan mengenai langkah yang perlu diambil untuk menjaga iklim akademik yang sehat tanpa mengabaikan kebebasan berpendapat mahasiswa. Tindakan yang paling tepat adalah...`,
      pilihan: {
        a: "Menyelenggarakan forum dialog lintas organisasi mahasiswa secara berkala yang mendorong pertukaran gagasan secara terbuka, disertai pendampingan dan penguatan nilai kebangsaan serta toleransi dalam kehidupan kampus.",
        b: "Mengintensifkan kegiatan sosialisasi mengenai bahaya radikalisme kepada seluruh mahasiswa agar mereka memahami risiko yang dapat timbul dari berkembangnya sikap eksklusif di lingkungan kampus.",
        c: "Mengundang pengurus komunitas tersebut untuk berdiskusi secara khusus guna memahami pandangan mereka dan mengingatkan pentingnya menjaga hubungan yang harmonis dengan kelompok lain.",
        d: "Memperketat pengawasan terhadap seluruh kegiatan kemahasiswaan yang berpotensi memunculkan perbedaan pandangan agar tidak berkembang menjadi konflik yang lebih luas.",
        e: "Mendorong organisasi mahasiswa lain untuk lebih aktif mengadakan kegiatan bersama sehingga interaksi antar kelompok meningkat dan potensi polarisasi dapat berkurang secara bertahap.",
      },
      scoringMap: {
        a: 5, // paling ideal (dialog lintas + edukasi nilai + inklusif + preventif)
        b: 4,
        c: 3,
        d: 2,
        e: 4,
    ...
    //no.70
    {
      ...
      topic: "Anti Radikalisme",
      nomor: 70,
      soal: `Anda merupakan kakak dari seorang remaja yang baru memasuki masa perkuliahan. Belakangan ini, ia sering mengikuti berbagai diskusi daring tentang agama dan mulai menunjukkan ketertarikan yang besar untuk mempelajari berbagai pandangan yang berbeda. Suatu hari, ia mengungkapkan kebingungannya karena memperoleh banyak informasi yang saling bertentangan dari media sosial, komunitas daring, dan beberapa kenalan baru. Keluarga ingin membantu proses pencarian pemahamannya tanpa memaksakan keyakinan tertentu maupun membatasi kebebasannya untuk belajar. Sikap yang paling tepat dilakukan keluarga adalah...`,
      pilihan: {
        a: "Memberikan ruang baginya untuk mengeksplorasi berbagai sumber informasi, sambil secara berkala mengajak berdiskusi agar ia dapat menilai setiap informasi berdasarkan logika, nilai kemanusiaan, dan sumber yang dapat dipertanggungjawabkan.",
        b: "Memfasilitasi dirinya untuk berdialog dengan tokoh-tokoh agama yang memiliki latar belakang pemikiran berbeda agar ia memperoleh gambaran yang lebih luas sebelum menentukan pandangannya sendiri.",
        c: "Mendorong dirinya untuk lebih aktif mengikuti kegiatan sosial lintas kelompok dan komunitas sehingga pemahamannya tentang keberagaman berkembang melalui pengalaman langsung.",
        d: "Mengarahkan dirinya untuk memperdalam pemahaman dari sumber-sumber yang telah diakui kredibilitasnya terlebih dahulu agar memiliki landasan yang kuat sebelum mempelajari pandangan lain yang lebih beragam.",
        e: "Mengajak seluruh anggota keluarga yang memiliki latar belakang keyakinan berbeda untuk berbagi pengalaman dan sudut pandang masing-masing sehingga ia dapat memahami berbagai perspektif secara lebih utuh.",
      },
      scoringMap: {
        a: 5, // paling ideal (kritis + seimbang + tidak mengarahkan secara ekstrem)
        b: 4,
        c: 4,
        d: 3,
        e: 4,
    ...
    // no.71
    {
      ...
      topic: "Anti Radikalisme",
      nomor: 71,
      soal: `Seorang petugas pembinaan di lembaga pemasyarakatan khusus menangani narapidana dengan kasus yang berkaitan dengan paham ekstrem. Dalam beberapa bulan terakhir, ditemukan bahwa sebagian warga binaan mulai menunjukkan penolakan terhadap program pembinaan umum dan lebih memilih berinteraksi dalam kelompok tertutup. Di sisi lain, pihak lapas memiliki keterbatasan tenaga pembina, sementara program pembinaan tetap harus berjalan efektif untuk mencegah penguatan paham menyimpang. Tindakan yang paling tepat dilakukan petugas adalah...`,
      pilihan: {
        a: "Memperketat pengawasan terhadap seluruh aktivitas warga binaan agar tidak terjadi komunikasi yang berpotensi memperkuat kelompok tertutup di dalam lapas.",
        b: "Menugaskan petugas pembinaan untuk melakukan pendekatan individual secara intensif kepada warga binaan yang menunjukkan penolakan terhadap program pembinaan umum.",
        c: "Mengoptimalkan program pembinaan berbasis dialog terstruktur yang melibatkan narasumber kompeten serta pendekatan kelompok yang mendorong keterbukaan dan refleksi kritis.",
        d: "Menyediakan bahan bacaan tambahan terkait wawasan kebangsaan dan moderasi beragama agar warga binaan dapat mempelajari secara mandiri tanpa ketergantungan pada petugas.",
        e: "Memberikan kesempatan kepada warga binaan untuk menjelaskan alasan mereka menolak program pembinaan agar petugas dapat menyesuaikan materi pembinaan di tahap berikutnya.",
      },
      scoringMap: {
        a: 2,
        b: 4,
        c: 5, // paling ideal (sistemik + dialog + narasumber + efektif untuk keterbatasan SDM)
        d: 3,
        e: 4,
      },
    },
    // no.72
    {
      ...
      topic: "Anti Radikalisme",
      nomor: 72,
      soal: `Seorang kepala dusun memimpin wilayah yang mayoritas warganya bekerja sebagai nelayan tradisional. Dalam beberapa bulan terakhir, pendapatan warga menurun akibat cuaca ekstrem dan berkurangnya hasil tangkapan. Kondisi ini dimanfaatkan oleh pihak luar melalui media sosial dan percakapan kelompok kecil untuk menyebarkan narasi yang dapat memecah belah warga serta mendorong sikap saling curiga terhadap pemerintah desa. Kepala dusun ingin mencegah berkembangnya pengaruh negatif tersebut tanpa mengabaikan kebutuhan ekonomi warga yang sedang tertekan. Tindakan yang paling tepat dilakukan adalah...`,
      pilihan: {
        a: "Mengajak kerja sama dengan instansi terkait untuk mengembangkan program pemberdayaan nelayan berbasis teknologi sederhana sekaligus memperkuat literasi digital agar warga tidak mudah terpengaruh informasi yang menyesatkan.",
        b: "Memastikan seluruh nelayan tetap melaporkan hasil tangkapan secara rutin kepada aparat desa agar distribusi bantuan dapat dilakukan secara lebih tepat sasaran.",
        c: "Mengadakan pertemuan rutin dengan para nelayan untuk mendengarkan keluhan mereka terkait kondisi ekonomi dan menyampaikan informasi resmi dari pemerintah desa secara berkala.",
        d: "Meminta warga untuk mengurangi penggunaan media sosial sementara waktu agar tidak terpengaruh oleh informasi yang belum jelas kebenarannya.",
        e: "Mengusulkan pembentukan kelompok kerja nelayan baru yang bertugas mengatur pembagian wilayah tangkap agar tidak terjadi persaingan yang dapat memicu konflik antarwarga.",
      },
      scoringMap: {
        a: 5, // paling ideal (solusi struktural + ekonomi + literasi digital + pencegahan disinformasi)
        b: 3,
        c: 4,
        d: 2,
        e: 3,
...

    {
      ...
      topic: "Sosial Budaya",
      nomor: 73,
      soal: "Seorang PNS guru muda ditugaskan mengikuti program penguatan literasi di wilayah kepulauan terpencil yang memiliki komunitas adat dengan bahasa lokal yang sangat dominan. Program ini melibatkan kolaborasi antara dinas pendidikan, organisasi nonpemerintah, serta tokoh masyarakat setempat. Setibanya di lokasi, Anda menyadari bahwa sebagian besar peserta didik dan warga pendamping tidak memahami bahasa Indonesia secara aktif, sementara waktu pelaksanaan program terbatas dan target capaian pembelajaran sudah ditetapkan. Di sisi lain, terdapat harapan dari pihak penyelenggara agar kegiatan tetap berjalan efektif tanpa penundaan. Dalam situasi tersebut, tindakan apa yang paling tepat Anda lakukan?",
      pilihan: {
        a: "Tetap melaksanakan kegiatan sesuai modul yang telah disusun sambil mengandalkan penerjemah lokal yang tersedia di lokasi agar penyampaian materi tetap berjalan sesuai jadwal.",
        b: "Mengamati terlebih dahulu pola komunikasi dan kebiasaan belajar masyarakat setempat untuk kemudian menyesuaikan cara penyampaian materi secara bertahap selama kegiatan berlangsung.",
        c: "Menghubungi kembali pihak dinas pendidikan dan mitra program untuk meminta penyesuaian target serta tambahan waktu adaptasi sebelum metode pembelajaran diterapkan sepenuhnya.",
        d: "Menyusun ulang strategi pembelajaran dengan menggabungkan pendekatan visual dan praktik sederhana, serta berkoordinasi dengan tokoh lokal untuk menjembatani perbedaan bahasa sejak awal kegiatan.",
        e: "Mengandalkan kemampuan diri untuk mempelajari bahasa lokal secara cepat sambil tetap menjalankan kegiatan, dengan harapan proses komunikasi akan membaik seiring berjalannya program.",
      },
      scoringMap: {
        a: 3,
        b: 4,
    ...
    // no.74
    {
      ...
      topic: "Sosial Budaya",
      nomor: 74,
      soal: "Anda baru saja ditempatkan sebagai analis kebijakan di sebuah kantor pelayanan publik tingkat kecamatan yang memiliki karakter masyarakat cukup beragam. Dalam beberapa minggu pertama, Anda mulai bekerja sama dengan tim lintas seksi. Namun, Anda memperhatikan bahwa salah satu rekan kerja sering menyampaikan kritik secara terbuka dan bernada tinggi dalam rapat koordinasi, yang membuat sebagian anggota tim menjadi enggan menyampaikan pendapat. Situasi ini mulai memengaruhi kualitas diskusi dan memperlambat pengambilan keputusan tim, sementara target kinerja harus segera dicapai. Dalam kondisi tersebut, sikap apa yang paling tepat Anda lakukan?",
      pilihan: {
        a: "Menghindari keterlibatan langsung dalam dinamika rapat dan tetap fokus pada tugas individu agar tidak terdampak suasana diskusi yang kurang kondusif.",
        b: "Mencatat pola interaksi yang terjadi dalam beberapa rapat untuk kemudian menyampaikan laporan kepada atasan agar dapat ditindaklanjuti secara formal.",
        c: "Mengajak rekan kerja yang bersangkutan berdiskusi secara pribadi dengan pendekatan yang tenang untuk menyampaikan dampak gaya komunikasinya terhadap efektivitas tim.",
        d: "Menyesuaikan diri dengan gaya komunikasi tersebut dan mulai bersikap lebih tegas dalam rapat agar tidak kalah dalam penyampaian pendapat.",
        e: "Menunggu hingga ada anggota tim lain yang menyampaikan keberatan terlebih dahulu agar Anda dapat menyesuaikan sikap tanpa menimbulkan konflik langsung.",
      },
      scoringMap: {
        a: 2,
        b: 3,
    ...
    //no.75
    {
      ...
      topic: "Sosial Budaya",
      nomor: 75,
      soal: "Seorang pegawai ASN yang baru bertugas di unit pelayanan administrasi kependudukan memiliki seorang rekan kerja satu tim yang selama ini dikenal sangat ramah dan membantu. Namun, belakangan Anda mengetahui bahwa rekan tersebut sedang menghadapi kondisi kesehatan serius yang memengaruhi konsentrasinya saat bekerja. Di sisi lain, beban pelayanan sedang meningkat dan tim dituntut menjaga kecepatan serta ketepatan layanan kepada masyarakat tanpa menurunkan kualitas. Rekan tersebut tidak pernah secara terbuka meminta bantuan, tetapi terlihat beberapa kali mengalami kesulitan dalam menyelesaikan tugas tepat waktu. Dalam situasi tersebut, apa tindakan yang paling tepat Anda lakukan?",
      pilihan: {
        a: "Menawarkan bantuan secara langsung kepada rekan tersebut untuk mengambil sebagian tugasnya agar beban kerjanya berkurang dan layanan tetap berjalan lebih cepat.",
        b: "Menjaga hubungan baik dengan tetap memberi dukungan moral dan sesekali membantu jika ia terlihat kesulitan tanpa mengubah pembagian tugas secara resmi.",
        c: "Mengajak rekan tersebut berdiskusi secara pribadi untuk memahami kondisinya lebih jauh dan bersama-sama mencari penyesuaian pembagian tugas yang tetap menjaga kualitas pelayanan tim.",
        d: "Melaporkan kondisi rekan tersebut kepada atasan agar dapat dipertimbangkan pengurangan beban kerja atau penyesuaian tugas secara formal.",
        e: "Membiarkan kondisi berjalan seperti biasa karena menganggap setiap pegawai tetap harus bertanggung jawab penuh terhadap tugas masing-masing tanpa pengecualian.",
      },
      scoringMap: {
        a: 4,
        b: 3,
    ...
    // no.76
    {
      ...
      topic: "Sosial Budaya",
      nomor: 76,
      soal: "Anda merupakan staf pada sebuah perusahaan jasa konsultan yang sering bekerja dalam tim lintas divisi. Dalam satu proyek internal, Anda juga dikenal memiliki hobi membuat kudapan rumahan yang sering dibagikan kepada rekan kerja sebagai bentuk membangun keakraban tim. Suatu waktu, beberapa rekan dari latar belakang keyakinan berbeda menyampaikan bahwa mereka hanya dapat mengonsumsi makanan tertentu dan meminta agar kudapan yang Anda buat disesuaikan tanpa bahan tertentu. Di sisi lain, Anda juga sedang menghadapi tenggat pekerjaan yang cukup padat sehingga waktu Anda terbatas. Dalam situasi tersebut, sikap apa yang paling tepat Anda lakukan?",
      pilihan: {
        a: "Menanyakan secara langsung kepada masing-masing rekan mengenai alasan dan kebutuhan spesifik mereka agar Anda dapat memahami batasan yang perlu diperhatikan.",
        b: "Mencari referensi tambahan dari berbagai sumber untuk memastikan bahan yang digunakan benar-benar sesuai dengan berbagai kebutuhan dan kepercayaan yang ada.",
        c: "Menyesuaikan resep sesuai permintaan masing-masing rekan dan tetap berusaha memenuhi semua pesanan meskipun harus membagi waktu lebih ketat.",
        d: "Menolak sementara permintaan tersebut dengan alasan kesibukan kerja agar fokus utama Anda tetap pada penyelesaian tugas proyek.",
        e: "Mengalihkan pembuatan kudapan kepada rekan lain yang lebih memiliki waktu luang agar semua permintaan tetap dapat terpenuhi tanpa mengganggu pekerjaan utama.",
      },
      scoringMap: {
        a: 4,
        b: 4,
    ...
    // no.77
    {
      ...
      topic: "Sosial Budaya",
      nomor: 77,
      soal: "Anda bekerja sebagai ASN pada sebuah unit analisis kebijakan dan sedang bersaing secara sehat dengan beberapa rekan seangkatan untuk mendapatkan kesempatan penugasan strategis di tingkat yang lebih tinggi. Dalam prosesnya, Anda mengetahui bahwa salah satu rekan Anda terpilih lebih dahulu untuk mengikuti penugasan tersebut melalui jalur kedekatan dengan pihak tertentu, meskipun secara kinerja ia tidak jauh berbeda dengan Anda. Situasi ini menimbulkan percakapan di antara beberapa rekan kerja lain yang mulai mempertanyakan objektivitas proses tersebut. Dalam kondisi tersebut, apa tindakan yang paling tepat Anda lakukan?",
      pilihan: {
        a: "Tetap fokus bekerja secara konsisten tanpa terlibat percakapan yang belum jelas kebenarannya dengan menjaga profesionalitas kinerja diri secara stabil dan berkelanjutan.",
        b: "Mengamati faktor yang memengaruhi keputusan penugasan dan menjadikannya bahan evaluasi diri tanpa menyebarkan isu di lingkungan kerja karena dianggap sebagai pembelajaran strategi karier.",
        c: "Mendengarkan percakapan yang berkembang di lingkungan kerja untuk memahami situasi tanpa ikut memperbesar isu yang beredar di antara rekan kerja agar tetap mengetahui dinamika organisasi.",
        d: "Menunggu penugasan berikutnya sambil tetap bekerja seperti biasa tanpa menanggapi isu yang ada di lingkungan kerja karena dianggap bukan ranah untuk direspon saat ini.",
        e: "Menyampaikan dugaan ketidakobjektifan kepada atasan agar dilakukan peninjauan ulang terhadap keputusan penugasan yang telah ditetapkan demi keadilan proses seleksi.",
      },
      scoringMap: {
        a: 5,
        b: 4,
...

    {
      ...
      topic: "Sosial Budaya",
      nomor: 78,
      soal: `Anda bekerja sebagai ASN pada unit perencanaan program yang baru saja menerapkan sistem digital berbasis spreadsheet terintegrasi untuk memantau realisasi kegiatan lintas bidang. Seorang rekan dari unit lain yang sedang menangani laporan mendadak menghubungi Anda karena mengalami kesulitan dalam menyusun formula otomatis untuk mengolah data yang cukup kompleks, sementara laporan tersebut harus segera dikompilasi untuk rapat pimpinan esok hari. Di sisi lain, Anda juga sedang menyelesaikan pekerjaan utama yang memiliki tenggat waktu hampir bersamaan. Dalam situasi tersebut, apa tindakan paling tepat yang Anda lakukan?`,
      pilihan: {
        a: "Meminta rekan tersebut mengirimkan detail kebutuhan dan struktur datanya agar Anda dapat membantu menyusun solusi formula secara lebih terarah setelah pekerjaan utama selesai",
        b: "Mengatur waktu untuk bertemu dan bersama-sama membahas serta membangun formula yang dibutuhkan agar solusi yang dihasilkan benar-benar sesuai dengan kebutuhan laporan",
        c: "Menyarankan rekan tersebut meminta bantuan ke unit lain yang lebih memahami pengolahan data agar masalah dapat diselesaikan lebih cepat tanpa membebani Anda",
        d: "Mencari berbagai contoh rumus dan panduan dari sumber digital untuk dipelajari terlebih dahulu sebelum memberikan solusi yang tepat kepada rekan tersebut",
        e: "Mendampingi rekan tersebut secara langsung untuk memahami alur data dan menyusun formula bersama di sistem yang digunakan agar ia dapat menguasainya untuk kebutuhan selanjutnya",
      },
      scoringMap: {
        a: 3,
        b: 5,
    ...
    //no.79
    {
      ...
      topic: "Sosial Budaya",
      nomor: 79,
      soal: `Anda merupakan koordinator kegiatan pada sebuah komunitas pengembangan pemuda di daerah yang memiliki keberagaman suku dan budaya. Dalam persiapan festival komunitas, muncul perbedaan pendapat mengenai penampilan budaya yang akan ditampilkan pada acara utama. Sebagian anggota menginginkan pertunjukan yang paling populer agar menarik banyak pengunjung, sedangkan kelompok lain berharap seluruh budaya lokal mendapat kesempatan yang seimbang. Di sisi lain, waktu persiapan semakin terbatas dan perdebatan mulai meluas ke media sosial komunitas sehingga berpotensi memengaruhi hubungan antaranggota. Apa yang paling tepat Anda lakukan?`,
      pilihan: {
        a: "Mengadakan musyawarah terbuka untuk mencari kesepakatan bersama meskipun berpotensi memerlukan penyesuaian jadwal kegiatan.",
        b: "Menetapkan pilihan berdasarkan jumlah dukungan terbanyak agar keputusan dapat segera dilaksanakan.",
        c: "Mengumpulkan masukan dari berbagai kelompok lalu menyusun keputusan yang mempertimbangkan keberagaman dan tujuan kegiatan secara seimbang.",
        d: "Meminta tokoh yang paling dihormati untuk menentukan pilihan agar perdebatan dapat segera berakhir.",
        e: "Memberikan kesempatan yang sama kepada seluruh kelompok meskipun harus mengurangi durasi setiap penampilan.",
      },
      scoringMap: {
        a: 4,
        b: 2,
    ...
    //no.80
    {
      ...
      nomor: 80,
      soal: "Pelaksanaan program kerja yang melibatkan beberapa unit sering menghadapi tantangan berupa perbedaan kesiapan implementasi, ketidaksesuaian data antarbagian, serta tekanan untuk tetap menyelesaikan pekerjaan sesuai batas waktu tanpa mengurangi ketepatan dan akuntabilitas hasil. Pada salah satu tahap pekerjaan, Anda terlibat pada proses integrasi data lintas unit dan mendapati sebagian pihak belum sepenuhnya mengikuti alur yang disepakati serta muncul dorongan untuk mempercepat penyelesaian dengan cara yang tidak sepenuhnya sesuai prosedur. Anda harus menentukan langkah paling tepat agar proses tetap berjalan efektif dan hasil tetap dapat dipertanggungjawabkan. Apa yang Anda lakukan?",
      pilihan: {
        a: "Memastikan seluruh proses tetap berjalan melalui alur resmi yang ditetapkan, disertai koordinasi aktif dengan unit terkait untuk melakukan penyelarasan dan verifikasi data secara langsung agar hasil tetap akurat dan terdokumentasi.",
        b: "Memprioritaskan pemenuhan tenggat dengan mengompilasi data yang tersedia dari berbagai sumber, kemudian melakukan validasi dan penyesuaian setelah hasil akhir disampaikan.",
        c: "Mengutamakan data yang telah konsisten untuk diproses terlebih dahulu, sementara bagian yang belum selaras ditunda hingga proses klarifikasi selesai dilakukan.",
        d: "Mengombinasikan mekanisme formal dan informal untuk mempercepat konsolidasi data, dengan penyesuaian akhir agar sesuai dengan ketentuan sistem yang berlaku.",
        e: "Mengikuti pola kerja tercepat yang digunakan sebagian pihak untuk menjaga kecepatan penyelesaian, kemudian melakukan penyesuaian akhir sebelum diserahkan sesuai ketentuan.",
      },
      scoringMap: {
        a: 5,
        b: 2,
    ...
    // no.81
    {
      ...
      topic: "Teknologi Informasi dan Komunikasi",
      nomor: 81,
      soal: "Instansi Anda menggunakan sistem e-office terintegrasi untuk pengelolaan surat dan disposisi pimpinan. Dalam proses penyusunan dokumen kebijakan lintas unit yang bersifat mendesak, Anda menemukan adanya perbedaan antara versi dokumen di sistem, hasil revisi pimpinan yang baru disampaikan melalui kanal informal, dan draft yang sudah terlanjur digunakan beberapa unit. Pimpinan menuntut keputusan cepat, tetapi akurasi versi final wajib terjaga karena berdampak pada kebijakan lintas sektor. Apa yang paling tepat Anda lakukan?",
      pilihan: {
        a: "Menjadikan e-office sebagai acuan utama, memastikan semua revisi hanya masuk melalui sistem agar versi final tetap konsisten dan dapat ditelusuri.",
        b: "Mengikuti arahan revisi terbaru dari pimpinan melalui kanal informal agar proses keputusan tidak terhambat.",
        c: "Membandingkan semua versi yang ada, lalu menyusun matriks perbedaan untuk dikonfirmasi kembali sebelum menetapkan versi final.",
        d: "Menggunakan versi yang paling banyak dipakai antar unit agar mempercepat kesepakatan dan mengurangi konflik versi dokumen.",
        e: "Menunda finalisasi sampai semua unit menyepakati satu versi yang sama untuk memastikan tidak ada perbedaan informasi.",
      },
      scoringMap: {
        a: 5,
        b: 1,
    ...
    // no.82
    {
      ...
      topic: "Teknologi Informasi dan Komunikasi",
      nomor: 82,
      soal: "Anda bekerja pada sebuah instansi pemerintah yang sedang melakukan percepatan transformasi digital dengan menerapkan beberapa sistem kerja baru berbasis aplikasi terintegrasi, termasuk pengelolaan data, komunikasi internal, dan pelaporan kinerja. Dalam periode transisi ini, pembaruan fitur dan alur kerja pada sistem sering terjadi dalam waktu singkat, sementara setiap unit dituntut tetap menjaga akurasi data, kecepatan pelaporan, dan konsistensi penggunaan sistem. Anda berada pada posisi yang harus memastikan pekerjaan tetap berjalan lancar di tengah perubahan yang dinamis, sementara sebagian rekan sudah lebih cepat beradaptasi dan sebagian lainnya masih menunggu arahan lebih lanjut. Dalam kondisi tersebut, tindakan paling tepat yang Anda lakukan adalah …",
      pilihan: {
        a: "Membiasakan diri mencatat setiap perubahan fitur dan alur kerja sistem secara sistematis sebagai referensi kerja pribadi agar dapat mengikuti perkembangan secara konsisten dalam jangka panjang.",
        b: "Menyeimbangkan antara eksplorasi fitur baru dan penyelesaian tugas harian dengan mengalokasikan waktu khusus untuk mencoba pembaruan sistem tanpa mengganggu target pekerjaan utama.",
        c: "Mengamati pola kerja rekan yang lebih cepat beradaptasi lalu mengadopsi cara penggunaan sistem yang terbukti efektif sambil tetap menyesuaikan dengan kebutuhan pekerjaan yang Anda tangani.",
        d: "Mengikuti seluruh sesi pembaruan atau sosialisasi sistem yang disediakan instansi secara aktif agar setiap perubahan dapat dipahami langsung dari sumber resmi sebelum diterapkan dalam pekerjaan.",
        e: "Mengutamakan penyelesaian pekerjaan dengan metode yang sudah paling dikuasai terlebih dahulu sambil menunda penggunaan fitur baru sampai terdapat kepastian stabilitas sistem dari pihak pengelola.",
      },
      scoringMap: {
        a: 4, // proaktif, mencatat sistematis → baik tapi lebih personal
        b: 5, // seimbang antara adaptasi dan target → paling ideal
        c: 3, // meniru rekan → cukup baik tapi kurang proaktif
        d: 4, // mengikuti sosialisasi resmi → benar, tapi bisa lambat adaptasinya
        e: 2, // menunda fitur baru → kurang responsif terhadap perubahan
      },
    },
    // no.83
    {
      ...
      topic: "Teknologi Informasi dan Komunikasi",
      nomor: 83,
      soal: "Petugas layanan publik di instansi pemerintah baru menerapkan sistem pengaduan masyarakat berbasis aplikasi terpadu. Masa awal penerapan sistem tersebut menimbulkan lonjakan laporan yang harus segera diproses, sementara sebagian data dari sistem lama belum sepenuhnya terintegrasi sehingga diperlukan validasi tambahan. Pimpinan menegaskan seluruh proses wajib tercatat melalui sistem baru untuk menjaga akuntabilitas, namun di lapangan beberapa rekan memilih cara manual agar penanganan lebih cepat. Kondisi ini menuntut kecepatan layanan tetap terjaga tanpa mengabaikan ketepatan data dalam sistem digital, sehingga Anda harus menentukan langkah yang paling tepat. Dalam situasi tersebut, tindakan paling tepat yang Anda lakukan adalah …",
      pilihan: {
        a: "Menggunakan sistem sebagai acuan utama sambil melakukan validasi bertahap agar layanan tetap cepat dan data tetap tercatat.",
        b: "Mengutamakan pencatatan manual untuk mempercepat penanganan lalu melakukan input ke sistem setelahnya.",
        c: "Membagi penggunaan sistem dan manual berdasarkan urgensi laporan agar pekerjaan lebih fleksibel.",
        d: "Mengikuti cara manual untuk kasus mendesak agar layanan lebih responsif terhadap masyarakat.",
        e: "Menunda input hingga sistem stabil agar tidak terjadi kesalahan data antar sistem.",
      },
      scoringMap: {
        a: 5,
        b: 2,
    ...
    // no.84
    {
      ...
      topic: "Teknologi Informasi dan Komunikasi",
      nomor: 84,
      soal: "Dalam era keterbukaan informasi, interaksi di ruang digital berkembang sangat cepat dan melibatkan banyak pihak dengan latar belakang serta kepentingan yang beragam. Setiap informasi yang dipublikasikan dapat memunculkan beragam respons, mulai dari dukungan, kritik, hingga penyebaran ulang yang tidak selalu sesuai konteks. Kondisi ini menuntut adanya pengelolaan komunikasi yang tepat agar informasi tetap dapat dipahami secara benar, tidak menimbulkan kesalahpahaman, serta tetap menjaga kualitas interaksi di ruang digital. Dalam situasi tersebut, sikap paling tepat yang Anda lakukan adalah …",
      pilihan: {
        a: "Menyusun perencanaan konten dan pola komunikasi digital secara sistematis agar penyampaian informasi dapat dilakukan secara konsisten dan terarah.",
        b: "Memberikan respons hanya pada komentar yang relevan dan bersifat konstruktif agar interaksi tetap fokus pada substansi informasi yang disampaikan.",
        c: "Menerapkan mekanisme penyaringan dan verifikasi informasi sebelum memberikan tanggapan terhadap komentar yang berpotensi menimbulkan kesalahpahaman.",
        d: "Merespons seluruh komentar secara cepat dengan pendekatan informatif agar seluruh pihak merasa mendapatkan perhatian yang sama.",
        e: "Mengabaikan komentar yang bersifat negatif dan fokus pada penyebaran informasi utama agar tidak terpengaruh dinamika percakapan yang tidak produktif.",
      },
      scoringMap: {
        a: 4,
        b: 3,
    ...
    // no.85
    {
      ...
      topic: "Teknologi Informasi dan Komunikasi",
      nomor: 85,
      soal: "Sebuah unit kerja layanan publik di lingkungan pemerintahan daerah tengah melakukan transformasi digital dengan mengintegrasikan beberapa kanal pelaporan menjadi satu sistem terpadu. Dalam masa implementasi awal, seorang analis kebijakan yang juga terlibat dalam perbaikan alur kerja menemukan adanya potensi peningkatan efisiensi melalui pemanfaatan fitur otomasi dan integrasi data lintas unit. Namun, sebagian tim masih berfokus pada penyesuaian operasional harian dan belum sepenuhnya siap menerima perubahan yang lebih teknis. Sementara itu, pimpinan meminta agar setiap ide perbaikan tidak hanya disampaikan secara lisan, tetapi juga terdokumentasi agar dapat ditindaklanjuti secara sistematis dan berkelanjutan. Dalam situasi tersebut, tindakan paling tepat yang sebaiknya dilakukan adalah …",
      pilihan: {
        a: "Menyampaikan gagasan peningkatan berbasis teknologi kepada pimpinan melalui kajian singkat disertai dokumentasi terstruktur agar dapat dievaluasi dan diintegrasikan ke dalam pengembangan sistem kerja",
        b: "Mengompilasi seluruh ide yang muncul dari berbagai anggota tim kemudian menyerahkannya kepada pimpinan tanpa analisis tambahan agar dapat diproses lebih cepat",
        c: "Menguji sebagian fitur yang tersedia secara mandiri pada lingkup kecil terlebih dahulu untuk memastikan manfaatnya sebelum menyampaikan rekomendasi kepada pimpinan",
        d: "Memfokuskan diri pada penyesuaian alur kerja yang sedang berjalan sambil menunda penyampaian ide sampai sistem benar-benar stabil digunakan oleh seluruh unit",
        e: "Mengarahkan rekan kerja untuk mengusulkan masing-masing ide perbaikan sesuai pengalaman operasional agar pimpinan memiliki banyak alternatif untuk dipertimbangkan",
      },
      scoringMap: {
        a: 5,
        b: 2,
    ...
    // no.86
    {
      ...
      topic: "Teknologi Informasi dan Komunikasi",
      nomor: 86,
      soal: "Pemerintah pusat mengimplementasikan integrasi layanan administrasi kependudukan, perizinan, dan bantuan sosial melalui sistem terpadu lintas instansi dalam rangka percepatan transformasi digital pelayanan publik. Dalam pelaksanaannya, terdapat sejumlah tantangan penyesuaian, yaitu perbedaan standar data antar daerah, variasi tingkat kesiapan infrastruktur jaringan, serta kebutuhan penyesuaian alur kerja petugas lapangan selama masa transisi karena masih dalam tahap adaptasi terhadap penggunaan beberapa sistem secara bersamaan. Di sisi lain, instansi pusat menegaskan bahwa layanan publik harus tetap berjalan optimal karena merupakan layanan esensial nasional. Sebagai penanggung jawab teknis, tindakan paling tepat adalah:",
      pilihan: {
        a: "Melakukan penundaan sementara proses integrasi sampai seluruh daerah memiliki keselarasan standar data dan kesiapan infrastruktur secara merata untuk menjamin konsistensi implementasi.",
        b: "Menjalankan seluruh sistem secara paralel selama masa transisi guna menjaga keberlanjutan layanan tanpa mengganggu proses operasional yang sedang berlangsung.",
        c: "Mengimplementasikan integrasi secara bertahap dengan standardisasi data, mekanisme sinkronisasi adaptif, serta penyederhanaan alur input untuk meningkatkan efisiensi kerja petugas lapangan.",
        d: "Menggunakan kembali mekanisme manual untuk sementara waktu guna memastikan pengendalian data yang lebih terpusat dan mudah ditelusuri dalam proses pelaporan.",
        e: "Memberikan fleksibilitas kepada masing-masing daerah dalam menyesuaikan mekanisme integrasi sesuai kondisi teknis dan kebutuhan operasional setempat.",
      },
      scoringMap: {
        a: 2,
        b: 4,
    ...
    // no.87
    {
      ...
      topic: "Teknologi Informasi dan Komunikasi",
      nomor: 87,
      soal: "Pemerintah melaksanakan program literasi digital nasional untuk meningkatkan kemampuan masyarakat dalam memilah informasi di ruang digital. Dalam pelaksanaannya, ditemukan peningkatan penyebaran informasi yang tidak akurat melalui media sosial, yang berdampak pada kebingungan publik terhadap informasi layanan pemerintah. Di sisi lain, pemerintah tetap mendorong keterbukaan informasi dan penggunaan platform digital sebagai sarana utama komunikasi publik. Sebagai bagian dari tim pelaksana program, tindakan paling tepat adalah:",
      pilihan: {
        a: "Menghentikan seluruh publikasi informasi di media digital sampai penyebaran informasi tidak akurat dapat sepenuhnya dikendalikan.",
        b: "Membatasi akses masyarakat terhadap media sosial tertentu untuk mengurangi potensi penyebaran informasi yang tidak akurat.",
        c: "Meningkatkan edukasi literasi digital, memperkuat kanal informasi resmi, serta melakukan klarifikasi cepat terhadap informasi yang tidak valid.",
        d: "Mengalihkan seluruh komunikasi publik kembali ke metode konvensional agar risiko penyebaran informasi tidak akurat dapat diminimalkan.",
        e: "Membiarkan arus informasi berjalan tanpa intervensi karena masyarakat diharapkan dapat menyaring informasi secara mandiri.",
      },
      scoringMap: {
        a: 2,
        b: 2,
